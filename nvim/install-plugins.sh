...
clone_or_pull "mfussenegger/nvim-dap" "nvim-dap"
clone_or_pull "nvim-neotest/nvim-nio" "nvim-nio"
clone_or_pull "rcarriga/nvim-dap-ui" "nvim-dap-ui"
clone_or_pull "theHamsta/nvim-dap-virtual-text" "nvim-dap-virtual-text"
