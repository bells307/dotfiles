...
require("treesitter-context").setup({ enable = require("core.state").get("treesitter_context", false) })
vim.keymap.set("n", "<leader>tc", function()
	require("treesitter-context").toggle()
	require("core.state").set("treesitter_context", require("treesitter-context").enabled())
end)
